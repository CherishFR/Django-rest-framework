"""
Django settings for 认证_权限_节流 project.
...
SECRET_KEY = '5-))b%qr1z9zxrefj2tv@%$yk3t*g08trk5rf^l6k90f!)w7y='
...
WSGI_APPLICATION = '认证_权限_节流.wsgi.application'
